...
import io.runon.trading.technical.analysis.indicators.market.mv.Mvp;
 ...
 * @author macle
 */
public class CryptocurrencyMvp {
    ...
    public static void main(String[] args) {
        ...
        Mvp mvp = new Mvp(symbolCandleTimes);

        int n = 14;

        TimeNumber[] array = mvp.getArray(10000);
