...
public class CryptocurrencySymbolCandle {
    ...
    public static IdCandlesGet[] getSpotSymbolCandles(String interval, long startOpenTime, long endTime ){
        return getSymbolCandles(SPOT_PATH, interval, startOpenTime, endTime);
    }

    public static IdCandlesGet[] getFuturesSymbolCandles(String interval, long startOpenTime, long endTime ){
        return getSymbolCandles(FUTURES_PATH, interval, startOpenTime, endTime);
    }

    public static IdCandlesGet[] getSymbolCandles(String path, String interval, long startOpenTime, long endTime){
